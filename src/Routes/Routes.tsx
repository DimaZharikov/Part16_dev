...
import PageLearnContainer from "../PagesApp/WrappedPages/PageLern/PageLernContainer";
...
const Routes : FC = () => {
    return (<>
            <Switch>
                ...
                <Route exact path = {`${RoutingType.cards_Grade}/:id`} render = {()=><PageLearnContainer/>}/>
